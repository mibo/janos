 ...
 */
public abstract class JanosServiceFactory {

  private static final String IMPLEMENTATION =
      "org.apache.olingo.odata2.janos.processor.core.rt.JanosServiceFactoryBuilderImpl";
   ...
   */
  private static JanosServiceFactoryBuilder getInstance() {
    return getInstance(IMPLEMENTATION, JanosServiceFactoryBuilder.class);
  }
  ...
  /**
   * Interface to be implemented for an instance of a {@link JanosServiceFactoryBuilder} which
   * provides an {@link ODataService} based on annotation from
   * <code>org.apache.olingo.olingo-odata2-api-annotation</code> module
   * (see package <code>org.apache.olingo.odata2.api.annotation.edm</code>).
   */
  public interface JanosServiceFactoryBuilder {
    /**
     ...
     */
    JanosServiceFactoryBuilder createFor(String modelPackage) throws ODataException;
     ...
     * @throws ODataException if an error during initialization occurs
     */
    JanosServiceFactoryBuilder createFor(Collection<Class<?>> annotatedClasses) throws ODataException;

    /**
     * Sets the DataStoreManager used by the JanosServiceFactory (ODataService)
     * @param dataStore DataStoreManager to be used
     * @return this builder (fluent builder)
     */
    JanosServiceFactoryBuilder with(DataStoreManager dataStore);

    /**
     * Sets the ValueAccess used by the JanosServiceFactory (ODataService)
     * @param valueAccess ValueAccess to be used
     * @return this builder (fluent builder)
     */
    JanosServiceFactoryBuilder with(ValueAccess valueAccess);

    /**
     * Sets the DataSource used by the JanosServiceFactory (ODataService)
     * @param dataSource DataSource to be used
     * @return this builder (fluent builder)
     */
    JanosServiceFactoryBuilder with(DataSource dataSource);
     ...
     * @return this builder (fluent builder)
     */
    JanosServiceFactoryBuilder extensions(Collection<Class<?>> extensions);

    /**
     * Finish building and build/create the configured The {@link JanosServiceFactory}
     * which then can be used to create thread safe {@link ODataService} ({@link JanosServiceFactory )} instances.
   ...
   * @throws ODataException if an error during initialization occurs
   */
  public static JanosServiceFactoryBuilder createFor(final String modelPackage) throws ODataException {
   ...
   * @throws ODataException if an error during initialization occurs
   */
  public static JanosServiceFactoryBuilder createFor(final Collection<Class<?>> annotatedClasses)
   ...
   */
  public abstract ODataService createService(ODataContext context);
}
