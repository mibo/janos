 ...
 * 
 */
public class EdmMock {

  public static EdmEntitySet getEntitySet(Edm edm, String entitySetName) throws EdmException {
  ...
  public static Edm createMockEdm() throws ODataException {
    ...
    final List<EdmEntitySet> edmEntitySets = Arrays.asList(employeeEntitySet, teamEntitySet,
        roomEntitySet, managerEntitySet, buildingEntitySet);
    ...
    when(edm.getEntitySets()).thenReturn(edmEntitySets);
